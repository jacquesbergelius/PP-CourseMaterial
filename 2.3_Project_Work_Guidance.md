...
1. The conceptual model has at least 4 different service points. Service point network can not be a straight line. There needs to be several paths throught the system.
